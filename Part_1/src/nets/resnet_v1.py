...
def bottleneck(inputs, depth, depth_bottleneck, stride, rate=1,
    ...
    Args:
      inputs: A tensorflow of size [batch, height, width, channels].
...
def resnet_v1(inputs,
    ...
    Args:
      inputs: A tensorflow of size [batch, height_in, width_in, channels].
    ...
    Returns:
      net: A rank-4 tensorflow of size [batch, height_out, width_out, channels_out].
