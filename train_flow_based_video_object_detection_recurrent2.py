...
from lstm import model_gru_concat
...
#=============================== II. building graph for east + agg =================================#
    ...
    learning_rate = tf.train.exponential_decay(FLAGS.learning_rate, global_step, decay_steps=500, decay_rate=500, staircase=True)
    ...
    for i, gpu_id in enumerate(gpus):
        with tf.device('/gpu:%d' % gpu_id):
            with tf.name_scope('model_%d' % gpu_id) as scope:
                ...
                total_loss, model_loss = model_gru_concat.tower_loss(iis, ifms, isms, igms, itms, gpu_id=gpu_id, config=config, reuse_variables=reuse_variables)
...
#============================= IV. Training over Steps(!!!)================================================#
    ...
    #>>>>>>>>>>>>>>> flow estimation with PWCnet
        ...
        for r in range(rounds):
            ...
            flow_maps_stack.append(y_hats[:, 1::4, 1::4, :])
