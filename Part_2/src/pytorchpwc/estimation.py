...
try:
    from pytorchpwc.correlation import correlation # the custom cost volume layer
except:
    sys.path.insert(0, './pytorchpwc/correlation'); from correlation import correlation  # you should consider upgrading python
# end
...
class Network(torch.nn.Module):
    def __init__(self):
        ...
        self.load_state_dict(torch.load('./pytorchpwc/models/' + arguments_strModel + '.pytorch'))
    # end
