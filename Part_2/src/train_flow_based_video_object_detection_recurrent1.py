...
tf.app.flags.DEFINE_boolean("vis", False, "whether to visualize data")
tf.app.flags.DEFINE_boolean("debug", False, "whether to enter data debug")
tf.app.flags.DEFINE_string('pre_processed', '/work/cascades/lxiaol9/ARC/EAST/data/pre-processed', "preprocessed ICDAR 2013")
#
...
tf.app.flags.DEFINE_string("prev_checkpoint_path", "/work/cascades/lxiaol9/ARC/EAST/checkpoints/GRU_agg/20181205-000440/model.ckpt-7042", 'AGG ckpt' )
...
#=============================== II. building graph for east + agg =================================#
    ...
    learning_rate = tf.train.exponential_decay(FLAGS.learning_rate, global_step, decay_steps=500, decay_rate=0.8, staircase=True)
...
#============================= III. Other necessary componets before training =============================#
    ...
    GPUtil.showUtilization()
    train_data_generator = icdar_smart.get_batch_seq(num_workers=FLAGS.num_readers, config=config, is_training=True)
