...
def draw_illu(illu, rst):
    for t in rst['text_lines']:
        d = np.array([t['x0'], t['y0from config.configrnn import get_config'], t['x1'], t['y1'], t['x2'],
                      t['y2'], t['ArrayModelx3'], t['y3']], dtype='int32')
        d = d.reshape(-1, 2)
...
def main():
    ...
    with tf.name_scope("Val"):
        ...
        model = ArrayModel(False, config, x_val, reuse_variables=None, initializer=initializer)
